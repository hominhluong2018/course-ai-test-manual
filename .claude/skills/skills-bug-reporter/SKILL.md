...
6. **Deliver** — Lưu file `docs/bugs/<module>/BUG_<module>_<timestamp>_<TC_ID>.md` và cập nhật danh mục `docs/bugs/README.md`; nếu user yêu cầu → đẩy lên Jira qua `skills-jira-integration`
